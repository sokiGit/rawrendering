...
- Circles (w/ outlines, can choose thickness)
...
<img src="./public/rawrenderer_example_web_browser.webp" alt="An example image of the program's output displaying a remake of a web browser window with a web-app open.">

## What's planned

I'll check these things as they get done :3

- [x] Moved to a lib instead of bin
    - [x] Benches
    - [x] Examples
- [ ] Memory optimization
- [ ] Text rendering
